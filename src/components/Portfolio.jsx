...
const Portfolio = () => {
  ...
  return (
    <section
      name="portfolio"
      className="w-full bg-cover h-full  bg-gradient-to-b from-zinc-800 to-gray-900 text-white pb-40"
    >
      <div className="max-w-screen-lg p-4 mx-auto flex flex-col justify-center w-full h-full">
        ...
        <p className="text-xl py-6 text-gray-200 font-bold">
          Here is a collection of a few of my Projects.
        </p>
        <div className="grid sm:grid-col-2 md:grid-col-3 gap-8 px-12 lg:gap-10 sm:px-0 lg:grid-cols-2 ">
          {projects.map(({ id, image, title, github, website }) => (
            <div
              key={id}
              className="max-w-lg flex shadow-lg shadow-gray-300 rounded-2xl overflow-hidden  p-4 mx-auto flex-row duration-500 hover:shadow-blue-500 bg-gray-700"
            >
              <img
                src={image}
                alt={title}
                className="w-2/3 rounded-lg duration-200 hover:scale-105"
              />
